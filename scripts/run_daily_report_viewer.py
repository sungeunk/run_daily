...
def main():
    ...
    with config_column_2:
        server_selection = st.selectbox("Select Server", ['DUT4015PTLH', 'ARLH-01', 'LNL-03', 'MTL-01', 'BMG-02', 'dg2alderlake'] if daily_list_on else sorted(os.listdir(args.report_dir)))
